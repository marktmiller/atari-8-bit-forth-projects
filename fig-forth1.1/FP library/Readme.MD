...
Using dmsc's MADS disassembly of Turbo Basic's math package [Turbo Basic XL v1.5 disassembly](https://github.com/dmsc/turbo-dis) as my source, I ported all of
